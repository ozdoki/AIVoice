...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            hotkey::register_hotkeys(
                ...
                hotkey::HotkeySet::new(
                    ...
                    loaded_settings.learn_selected_hotkey,
                    loaded_settings.voice_edit_selected_hotkey,
                ),
            )?;
            // システムトレイを作成
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cancel_recording_session,
            ...
            commands::get_data_processing_summary,
            ...
            commands::preview_correction,
            commands::revalidate_correction_artifacts,
            commands::prepare_selected_correction,
            commands::preview_selected_correction,
            commands::revalidate_selected_correction_artifacts,
            commands::create_selected_correction,
            commands::cancel_selected_correction,
            commands::show_main_for_selected_correction_error,
            commands::toggle_selected_voice_edit,
            commands::get_selected_voice_edit_status,
            commands::replace_selected_voice_edit,
            commands::cancel_selected_voice_edit_preview,
            commands::get_corrections,
            commands::create_correction,
            commands::update_correction,
            commands::undo_correction,
            commands::reactivate_correction,
            commands::delete_correction,
            commands::clear_corrections,
            ...
            commands::get_app_profile_conflict_warnings,
            commands::create_app_profile,
            commands::update_app_profile,
            commands::set_app_profile_enabled,
            commands::delete_app_profile,
            commands::clear_app_profiles,
            commands::preview_current_app_profile,
